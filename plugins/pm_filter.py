...
from database.connections_mdb import active_connection, all_connections, delete_connection, if_active, make_active, \
    make_inactive
from info import ADMINS, AUTH_CHANNEL, AUTH_USERS, CUSTOM_FILE_CAPTION, DELETE_TIME, AUTH_GROUPS, P_TTI_SHOW_OFF, NOR_IMG, IMDB, \
...
async def advantage_spoll_choker(bot, query):
    ...
    if k == False:
        ...
        if files:
            ...
            k = await query.message.edit('This Movie is Not Uploaded in My DataBase.😢\nPlease ask the Admins in this Format👇\n@admin (movie name)\nAdmins will upload the movie and will let you know☺.')
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🤖 Updates', url='https://t.me/megatronzrequest')
        ], [
        ...
        buttons = [[
            ...
            InlineKeyboardButton('👑Bot Owner', url='https://t.me/Dark_Lord_8')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
